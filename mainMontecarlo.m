...
exportgraphics(stoch_time_w,'.\report_images\stoch_time_w.eps','ContentType','vector')
exportgraphics(stoch_time_histo,'.\report_images\stoch_time_histo.eps','ContentType','vector')
exportgraphics(stoch_mean_std,'.\report_images\stoch_mean_std.eps','ContentType','vector')